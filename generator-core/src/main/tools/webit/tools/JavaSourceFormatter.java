// Copyright (c) 2013-2.14, Webit Team. All Rights Reserved.
package webit.tools;
...
public class JavaSourceFormatter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        formatter.formatJava("F:\\Workspace\\Webit-generator\\generator-core");
    }
...
// ---------------------------------------------------------------- rules
    ...
    private String checkCopyright(String content, String filePath) {
        ...
        // ignore
        if (content.contains("Jodd Team (jodd.org). All Rights Reserved.")) {
            return content;
        }
